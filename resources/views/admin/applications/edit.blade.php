    ...
    <div class="card-body box box-solid box-success">
        <form action="{{ route("admin.applications.update", [$application->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('app_country') ? 'has-error' : '' }}">
                ...
                <input type="text" id="user_city" name="user_city" class="form-control" value="{{ old('app_city', isset($application) ? $application->app_city : '') }}">
                ...
                <input type="text" id="user_state" name="user_state" class="form-control" value="{{ old('app_state', isset($application) ? $application->app_state : '') }}">
